...
while True:
    registration_mode: str = input('have you registered in our site?:[YES/NO] ').upper() # noqa E501
    match registration_mode:
        case "YES":
            # we ask for username
            # we check if username is available in our database
            # by user pass check method
            ...
            logged_in: bool = User.check_user_password("user_info.json", username, password) # noqa E501
            if logged_in is True:
                ...
                continue
        case "NO":
            # user class need username full name address password phone number
            ...
            user_info: object = User(username, full_name, address, phone_number, password) # noqa E501
            # write user info method and write info of instance we made
...
while True:
    ...
    match user_command:
        case '1':
            password, full_name, address, phone_number = User.get_users_info('user_info.json', username) # noqa E501
            logged_in_user: object = User(username, full_name, address, phone_number, password) # noqa E501
            ...
            while True:
                ...
                match to_edit_info:
                    case "1":
                        ...
                        info_edit_type: str = input(CommandsMsg.chose_command).upper()# noqa E501
                        # we get new info and make instance
                        # we put new info inside dict and
                        # delete prev info and overwrite new info
                        match info_edit_type:
                            case 'USERNAME':
                                new_username: str = input(InfoMsg.enter_n_username) # noqa E501
                                username = new_username
                                continue
                            case 'NAME':
                                new_full_name: str = input(InfoMsg.enter_n_full_name) # noqa E501
                            ...
                            case 'PHONE':
                                ...
                                continue
                            case 'ADDRESS':
                                new_address: str = input(InfoMsg.enter_n_address) # noqa E501
                                address = new_address
                                continue
                            case 'PASSWORD':
                                while True:
                                    ...
                                    new_password: str = input(InfoMsg.enter_n_password) # noqa E501
                                    new_password_confirm: str = input(InfoMsg.enter_n_pass_confirm) # noqa E501
                        ...
                        new_user_info: object = User(username, full_name, address, phone_number, password) # noqa E501
...
while True:
    ...
    if new_item not in shop.items:
        match new_item:
            ...
            case _:
                available_products = Product.check_available_products('shopping_list_data.json') # noqa E501
...
for i in range(len(shopping_list)):
    ...
    os.system("cls" if os.name == 'nt' else "clear")
    available_products_dict = Product.get_products_dict('shopping_list_data.json') # noqa E501
